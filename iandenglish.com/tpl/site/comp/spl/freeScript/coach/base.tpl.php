...
<div id="chouseTimeBox" class="hidden">
    ...
    <div class="childLeft">
        <div>
            ...
            <div><a href="#confirmBox" id="selectBtn" class="button blue" title="Нажмите, что бы забронировать время">Сохранить</a></div>
        </div>
    ...
    <h5>Стоимость:</h5>
    <p>
        Стоимость <strong>общения/корректировки с репетитором</strong>,
        составляет всего <span id="priceText"></span> руб. за 15 минут.
        <a href="#" title="Нажмите, что бы узнать, почему выбранно 15 минут">Почему 15 минут?</a>
    </p>

</div> <!-- <div id="chouseTimeBox"> -->

<div id="confirmBox" class="hidden">
    <h5>Подтвердите выбранное время</h5>
    ...
    <div style="text-align: center;"><a href="#confirm" id="confirmBtn" class="button blue">Все правильно. Сохранить</a></div>
</div>

<div id="confirmRemoveBox" class="hidden">
    <h5>Подтвердите отмену</h5>
    <div class="box information">Вы собираетесь отменить встречу?</div>
    <p>Внимание: При отмене заявки менее, чем за 24 часа, возвращаеться 50% оплаты, более чем за 24 часа возвращается полная оплата</p>
    <div style="text-align: center;"><a href="#confirmRemove" id="confirmRemoveBtn" class="button blue">Да.Все правильно</a></div>
</div>
