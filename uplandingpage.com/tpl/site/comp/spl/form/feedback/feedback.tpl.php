    ...
    <div class="contactWrap">
        <form class="contactForm" id="contactForm">
            <p>
                ...
                <input type="text" value="" name="feedback[name]" class="nameInput" title="Напишите Ваше имя" placeholder="Ваше имя"/>
            </p>
            <p>
                <label>Ваш Email: </label>
                <input type="text" name="feedback[email]" value="" class="emailInput" title="Напишите Ваш Email" placeholder="Ваш Email"/>
            </p>
            <p>
            ...
            <p>
                ...
                <textarea class="messageInput" title="Напишите Ваше сообщение" name="feedback[msg]" placeholder="Ваше сообщение"></textarea>
            </p>
            <p>
