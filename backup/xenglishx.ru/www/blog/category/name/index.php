...
// ====== Varible COMP(name)
$name = 'name';
dbus::$vars[$name] = \core\comp\spl\objItem\vars\db\table::getIdByName(request::get($name), 'category','29','3');
if ( !dbus::$vars[$name] ){
    header('Status: 404 Not Found');
    exit;
}
...
);dbus::$comp['socialBtn'] = array (
  'tpl' => false,
  'isTplOut' => 0,
  'compId' => '2',
  'nsPath' => 'spl/html/',
  'contId' => '43',
);try{\site\core\site\comp\spl\objItem\logic\blog\article::init('article');;
}catch(Exception $ex){
...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="ru-RU">
	<head>
		...
		<?echo '<meta name="description" content="'.dbus::$comp['article']['data']['seo']['descr'].'" /><meta property="og:description" content="'.dbus::$comp['article']['data']['seo']['descr'].'"/>';echo '<meta name="keywords" content="'.dbus::$comp['article']['data']['seo']['keywords'].'" />';echo '<title>'.dbus::$vars['name']['caption'].'</title><meta property="og:title" content="'.dbus::$vars['name']['caption'].'"/>';echo '<meta property="og:image" content="'.dbus::$comp['article']['data']['seo']['imgUrl'].'"/><link rel="image_src" href="'.dbus::$comp['article']['data']['seo']['imgUrl'].'" />';?><script>var dbus={};var importResList={"js":[],"css":[]};</script>        <meta name="viewport" content="width=device-width" />
...
<div id="content">
    <div class="wrapper">
            ...
            <div class="block main-content" id="sidebar-right">
                ...
                <div id="main-content">
                    <?php \site\core\site\comp\spl\objItem\logic\blog\article::renderAction('article'); ?>
<?php \core\comp\spl\html\logic\html::renderAction('socialBtn'); ?>
                </div>
                <div class="clear"></div>
                            </div>
            <div class="clear"></div>
