...
if ( !dbus::$vars[$name] ){
  ...
  'nsPath' => 'spl/menu/',
  'contId' => '8',
);dbus::$comp['authbox'] = array (
  'tpl' => 'auth.tpl.php',
  'isTplOut' => 1,
  'compId' => '20',
  'nsPath' => 'spl/freeScript/',
  'contId' => '36',
);dbus::$comp['bookmarkBtn'] = array (
  'tpl' => false,
  'isTplOut' => 0,
  'compId' => '2',
  'nsPath' => 'spl/html/',
  'contId' => '58',
);try{\site\core\site\comp\spl\objItem\logic\eng\main::init('article');;
\core\comp\spl\freeScript\logic\freeScript::init('authbox');;
}catch(Exception $ex){
...
<div id="content">
    <div class="wrapper">
            ...
            <div class="block main-content" id="sidebar-right">
                <div id="sidebar">
                    <?php \core\comp\spl\freeScript\logic\freeScript::renderAction('authbox'); ?>
<?php \core\comp\spl\html\logic\html::renderAction('bookmarkBtn'); ?>
                </div>
                <div id="main-content">
                    <?php \site\core\site\comp\spl\objItem\logic\eng\main::renderAction('article'); ?>
                </div>
                <div class="clear"></div>
                            </div>
            <div class="clear"></div>
