...
try{
  ...
  'nsPath' => 'spl/menu/',
  'contId' => '8',
);dbus::$comp['feedback'] = array (
  'tpl' => 'feedback/feedback.tpl.php',
  'isTplOut' => 1,
  'compId' => '18',
  'nsPath' => 'spl/form/',
  'contId' => '57',
  'action' => NULL,
);try{\core\comp\spl\form\logic\form::init('feedback');;
}catch(Exception $ex){
...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="ru-RU">
	<head>
		...
		<?echo '<title>Контакты</title><meta property="og:title" content="Контакты"/>';?><script>var dbus={};var importResList={"js":[],"css":[]};</script>        <meta name="viewport" content="width=device-width" />
...
<div id="content">
    <div class="wrapper">
            ...
            <div class="block main-content" id="sidebar-right">
                ...
                <div id="main-content">
                    <?php \core\comp\spl\form\logic\form::renderAction('feedback'); ?>
                </div>
                <div class="clear"></div>
                            </div>
            <div class="clear"></div>
