...
try{
  ...
  'nsPath' => 'spl/menu/',
  'contId' => '8',
);dbus::$comp['profile'] = array (
  'tpl' => 'user.tpl.php',
  'isTplOut' => 1,
  'compId' => '20',
  'nsPath' => 'spl/freeScript/',
  'contId' => '48',
);try{\core\comp\spl\freeScript\logic\freeScript::init('profile');;
}catch(Exception $ex){
...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="ru-RU">
	<head>
		...
		<?echo '<title>Личный кабинет</title><meta property="og:title" content="Личный кабинет"/>';?><script>var dbus={};var importResList={"js":[],"css":[]};</script>        <meta name="viewport" content="width=device-width" />
...
<div id="content">
    <div class="wrapper">
            ...
            <div class="block main-content" id="sidebar-right">
                ...
                <div id="main-content">
                    <?php \core\comp\spl\freeScript\logic\freeScript::renderAction('profile'); ?>
                </div>
                <div class="clear"></div>
                            </div>
            <div class="clear"></div>
