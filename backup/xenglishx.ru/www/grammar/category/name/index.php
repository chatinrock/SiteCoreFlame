...
// ====== Varible COMP(name)
$name = 'name';
dbus::$vars[$name] = \core\comp\spl\objItem\vars\db\table::getIdByName(request::get($name), 'category','11','3');
if ( !dbus::$vars[$name] ){
    header('Status: 404 Not Found');
    exit;
}
...
);try{\core\comp\spl\objItem\logic\article\article::init('article');;
}catch(Exception $ex){
...
<div id="content">
    <div class="wrapper">
            ...
            <div class="block main-content" id="sidebar-right">
                ...
                <div id="main-content">
                    <?php \core\comp\spl\objItem\logic\article\article::renderAction('article'); ?>
                </div>
                <div class="clear"></div>
                            </div>
            <div class="clear"></div>
