...
if ( !dbus::$vars[$name] ){
  ...
  'nsPath' => 'spl/oiLaster/',
  'contId' => '28',
);try{\core\comp\spl\freeScript\logic\freeScript::init('authbox');;
}catch(Exception $ex){
...
<div id="content">
    <div class="wrapper">
            ...
            <div class="block main-content" id="sidebar-right">
                ...
                <div id="main-content">
                    <?php \core\comp\spl\oiList\logic\blog::renderByCategoryAction('agrlist'); ?>
                </div>
                <div class="clear"></div>
                            </div>
            <div class="clear"></div>
