...
// ====== Varible COMP(name)
$name = 'name';
dbus::$vars[$name] = core\comp\spl\objItem\vars\db\table::getIdByName(request::get($name), 'category','4','3');
if ( !dbus::$vars[$name] ){
    header('Status: 404 Not Found');
    exit;
}
...
dbus::$comp['bcrumbs'] = array(
	...
	'contId' => '18',
	'breadcrumbs' => [
		['caption' => 'Категория','name' => 'category'],
		['caption' => 'Статья','name' => 'name'],
	]
);
dbus::$comp['comments'] = array(
	'tpl' => 'main.php',
	'compId' => '11',
	'nsPath' => 'spl/oiComment/',
	'contId' => '22',
	'varible' => 'name',
	'blockItemId' => '9',
	'type' => 'image'
...
core\comp\spl\oiComment\logic\main::init('comments');;
}catch(Exception $ex){
...
<?php core\comp\spl\oiPopular\logic\main::renderAction('popular'); ?>
                ...
                <div id="main-content">
                    ...
                    <?php core\comp\spl\objItem\logic\article\article::renderAction('article'); ?>
										<?php core\comp\spl\oiRandom\logic\main::renderAction('apost'); ?>
					<?php core\comp\spl\oiComment\logic\main::renderAction('comments'); ?>
					                </div>
                <div class="clear"></div>
                            </div>
            <div class="clear"></div>
