...
// ====== Varible COMP(article)
$name = 'article';
dbus::$vars[$name] = \site\core\comp\spl\article\vars\db\table::getIdByName(request::get($name), 'category','326','3');
if ( !dbus::$vars[$name] ){
    header('Status: 404 Not Found');
    exit;
}
...
dbus::$comp['article'] = array(
	...
	'varTableName' => 'article',
	'urlTpl' => [
		'category'=>'/blog/%s/',
	]
);
dbus::$comp['comment'] = array(
	'tpl' => 'main.php',
	'compId' => '11',
	'nsPath' => 'spl/artCom/',
	'contId' => '336',
...
site\core\comp\spl\artCom\logic\simple::init('comment');;
}catch(Exception $ex){
...
<html lang="" dir="ltr">
    <head>
        ...
        <?
        echo '<title>'.dbus::$vars['article']['caption'].'</title>'.PHP_EOL;
...
<div id="main" class="grid-block">
    ...
    <section id="content" class="grid-block"><div id="system">
        <article class="item" data-permalink="/wordpress/dryer/?p=1">
            ...
            <?php site\core\comp\spl\artCom\logic\simple::renderAction('comment'); ?>
        </article>
    </div>
</section></div>
