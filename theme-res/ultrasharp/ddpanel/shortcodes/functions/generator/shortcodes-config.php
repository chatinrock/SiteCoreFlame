		...
		array(
			...
			'shortcodes' => array(
				...
				array(
					...
					'name' => 'pricetable',
					'type' => 'wrapped',
					'title' => 'Pricetable Wrapper – Step 1',
					'fields' => array(
					
						array(
						
							'type' => 'info',
							'desc' => 'This is the first step to create your pricing table. To start of select the number of columns it will have. Next, you will need to add the same number of pricetable_column shortcodes (step 2)',
						...
						array(
							...
							'desc' => 'This is the total number of columsn you\'ll have in your table.',
				...
				array(
					...
					'name' => 'pricetable_column',
					'type' => 'wrapped',
					'title' => 'Pricetable Column – Step 2',
					'fields' => array(
					
						array(
						
							'type' => 'info',
							'desc' => 'This is your pricing table column. You will need to add the same amount of columns as you added on step 1. So if you chose 4, you need to insert this hsortcode 4 times.<br><br>In Step 3, you will add features to each column.',
						...
						array(
							...
							'type' => 'text',
							'title' => 'Category',
							'desc' => 'This is the category of your pricing table. Shows at the very top.',
						...
						array(
							...
							'type' => 'text',
							'title' => 'Price',
							'desc' => 'Amount in dollars. No cents here.',
						...
						array(
							...
							'type' => 'text',
							'title' => 'Cents',
							'desc' => 'This is the amount of cents.',
						...
						array(
							...
							'desc' => 'This is your currency symbol.',
						...
						array(
							...
							'desc' => 'This is an optional message that shows below your price.',
						...
						array(
							...
							'type' => 'text',
							'title' => 'Button Text',
							'desc' => 'Text of your column button. Shows at the very bottom.',
						...
						array(
							...
							'type' => 'text',
							'title' => 'Link',
							'desc' => 'The URL your button will lead the user to upon clicking.',
						...
						array(
							...
							'name' => 'special',
							'type' => 'check',
							'title' => 'Make this column special?',
							'desc' => 'Special columns have way more visibility and impact.',
							'value' => 'true',
				...
				array(
					...
					'name' => 'pricetable_features',
					'type' => 'wrapped',
					'title' => 'Pricetable Features – Step 3',
					'fields' => array(
					
						array(
						
							'type' => 'info',
							'desc' => 'This is the last step. This will insert the features shortcode. To add the items use the following markup (inside the features shortcode):<br>
							<br>
							&lt;li class="yes">&lt;span>Discounted Price&lt;/span>&lt;/li><br>
							for a TICK icon<br>
							<br>
							&lt;li class="no">&lt;span>Discounted Price&lt;/span>&lt;/li><br>
							for a X icon',
