<?php
	...
	function ddshort_image_frame($atts, $content = null) {
		...
		if($style == 1 || $style == 2) {
		   ...
		   //// CLOSES OUTPUT 
		   $return .= '<span class="bottom-shadow" style="top: '.$height.'px"><img src="'.get_template_directory_uri().'/ddpanel/shortcodes/images/shortcodes/frames/frame4-bottom.png" width="'.$width.'" /></span>
		   </span>';
