<?php
	...
	function ddshort_contact_form($atts, $content = null) {
		...
		//// OUR FORM
		$output .= '<form action="'.get_template_directory_uri().'/ddpanel/shortcodes/functions/contact/mail.php" method="post" class="ddContactForm">
			...
			<p><input type="submit" value="'.__('Submit', 'DDShortcode_Contact').'" id="contactSubmit" /><input type="reset" value="'.__('Reset', 'DDShortcode_Contact').'" id="contactReset" /></p>
