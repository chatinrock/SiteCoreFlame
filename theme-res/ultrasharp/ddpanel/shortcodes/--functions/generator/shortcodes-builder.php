...
<link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/ddpanel/shortcodes/css/generator.css" media="screen" />
<script src="<?php echo get_template_directory_uri(); ?>/ddpanel/shortcodes/js/generator.js" type="text/javascript" charset="utf-8"></script>
            ...
            <div class="shortcode-fields">
				...
				?>
                    ...
                    <div class="shortcode-fields-field shortcode-field-text">
                        ...
                        <?php if($field['image']) { echo '<span class="hidden shortcode-image">true</span>'; } ?>
