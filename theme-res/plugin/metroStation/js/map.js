...
var panel = {
	init: function() {
		this.findObj = new findBtn("#findDrop", function() {
			if ( this.selected ){
		...
		$('#selectBtn').click(that.selectBtnClick);
	},
	selectBtnClick: function() {
		panel.cbReturnMetroSelect(stationMap.getStationSelect());
		window.close();
	},
	
	cbReturnMetroSelect: function(){
		// Переопределить в родителе
		console.log('Overload cbReturnMetroSelect in parent');
		// func. cbReturnMetroSelect
	}
