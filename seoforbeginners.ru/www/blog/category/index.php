...
<html lang="" dir="ltr">
    <head>
        ...
        <?
        echo '<title>SEO для начинающих. Категория: '.dbus::$vars['category']['caption'].'</title>'.PHP_EOL;
        ...
        site\core\comp\spl\artList\logic\artList::setListCategorySeo('artlist', ['linkNextTitle'=>'Блог | %s | Страница %s','linkNextUrl'=>'/blog/%s/']);
...
<div id="main" class="grid-block">
    ...
    <?php site\core\comp\spl\artList\logic\artList::renderByCategoryAction('artlist'); ?>
</div>
