...
// ====== Varible COMP(num)
$name = 'num';
dbus::$vars[$name] = \site\core\comp\spl\artList\vars\db\number::checkByNum(request::get($name),null,'12','10');
if ( !dbus::$vars[$name] ){
...
dbus::$comp['breadcrumbs'] = array(
	...
	'contId' => '10',
	'breadcrumbs' => [
		['caption' => 'Страница %s','name' => 'num'],
	]
);
dbus::$comp['artlist'] = array(
	'tpl' => 'main.php',
	'compId' => '10',
	'nsPath' => 'spl/artList/',
	'varName' => 'num',
...
<html lang="" dir="ltr">
    <head>
        ...
        <?
        echo '<title>Seo оптимизация для начинающих. Что нужно знать. Страница '.dbus::$vars['num']['num'].'</title>'.PHP_EOL;
        echo '<meta name="description" content="Seo оптимизация для начинающих. Что нужно знать что бы преуспеть в раскрутке." />'.PHP_EOL;
        echo '<meta name="keywords" content="Seo оптимизация, seo, раскрутка сайтов" />'.PHP_EOL;
        site\core\comp\spl\artList\logic\artList::setListSeo('artlist', ['linkNextTitle'=>'Страница %s','linkNextUrl'=>'/blog/%s/%s/']);
...
<div id="main" class="grid-block">
    ...
    <?php site\core\comp\spl\artList\logic\artList::renderByOneAction('artlist'); ?>
</div>
