...
<html lang="" dir="ltr">
    <head>
        ...
        <?
        echo '<title>Seo оптимизация для начинающих. Что нужно знать.</title>'.PHP_EOL;
        ...
        site\core\comp\spl\artList\logic\artList::setListSeo('list', ['linkNextTitle'=>'Страница %s','linkNextUrl'=>'/blog/page/%s/']);
...
<div id="main" class="grid-block">
    ...
    <?php site\core\comp\spl\artList\logic\artList::renderByOneAction('list'); ?>
</div>
